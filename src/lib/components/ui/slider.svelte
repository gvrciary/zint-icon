...
<div class={cn('space-y-3', className)} {...restProps}>
	...
	<div class="relative">
		...
		>
			<div
				class="absolute left-0 top-0 h-full rounded-full bg-gradient-to-r from-black/60 via-black/70 to-black/50 transition-all duration-200 ease-out dark:from-white/80 dark:via-white/90 dark:to-white/70"
